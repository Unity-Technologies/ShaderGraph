...
namespace UnityEditor.ShaderGraph
{
   public class HDUnlitSubShader
   {
       struct Pass
       {
           ...
           public List<int> VertexShaderSlots;      // list of slots needed for this pass
           public List<int> PixelShaderSlots;       // list of slots needed for this pass
        }
       ...
       Pass m_PassDepthOnly = new Pass()
       {
           ...
           ShaderPassInclude = "ShaderPassDepthOnly.hlsl",
        ...
        Pass m_PassForwardUnlit = new Pass()
        {
            Name = "ForwardUnlit",
            LightMode = "ForwardOnly",
            ShaderPassName = "SHADERPASS_FORWARD_UNLIT",
            ShaderPassInclude = "ShaderPassForwardUnlit.hlsl",
            PixelShaderSlots = new List<int>()
           {
               UnlitMasterNode.ColorSlotId,
               UnlitMasterNode.AlphaSlotId
        ...
        Pass m_PassDebugDisplay = new Pass()
        {
           Name = "ForwardDebugDisplay",
           LightMode = "ForwardOnlyDebugDisplay",
           ShaderPassName = "SHADERPASS_FORWARD_UNLIT",
           ShaderPassInclude = "ShaderPassForwardUnlit.hlsl",
           PixelShaderSlots = new List<int>()
           {
        ...
        Pass m_PassMETA = new Pass()
        {
            ...
            ShaderPassInclude = "ShaderPassLightTransport.hlsl",
            PixelShaderSlots = new List<int>()
            {
               UnlitMasterNode.ColorSlotId,
               UnlitMasterNode.AlphaSlotId
        ...
        private static string GetShaderPassFromTemplate(UnlitMasterNode masterNode, Pass pass, GenerationMode mode)
        {
           ...
           foreach (var id in pass.PixelShaderSlots)
            ...
            GraphUtil.GenerateSurfaceDescription(
               ...
               functionRegistry,    // shaderFunctionVisitor,
               shaderProperties,
               requirements,
               mode,
               "PopulateSurfaceData",
           ...
           graph.AddShaderChunk("// Function Visitor", false);
           ...
           graph.AddShaderChunk("// Shader Properties", false);
